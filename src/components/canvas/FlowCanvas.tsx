...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <p>This HTML was generated by the G-Nexus AI workflow tree.</p>
            <p>All branches processed successfully and merged into this output.</p>
        </div>
        
        <div class="footer">
            Generated by G-Nexus AI • ${new Date().toLocaleString()}
        </div>
    </div>
</body>
</html>`;
